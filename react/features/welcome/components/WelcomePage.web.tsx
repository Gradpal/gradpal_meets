...
class WelcomePage extends AbstractWelcomePage<IProps> {
                    ...
                    <div className="header-container">
                        <div className="header-watermark-container">
                            <div className="welcome-watermark">
                                <Watermarks
                                    defaultJitsiLogoURL={"images/logo-deep-linking-mobile.png"}
                                    noMargins={true}
                                />
                            </div>
                        </div>
                        ...
                        <h1 className="header-text-title" style={{ color: "#005fcc", fontWeight: "bold" }}>
    ...
    _renderFooter() {
        ...
        return (
            ...
            >
                <span style={{ textAlign: "center", width: "100%" }}>Copyright 2025 Gradpal. All rights reserved.</span>
            </footer>
        );
    }
