...
class Watermarks extends Component<IProps, State> {
    ...
    constructor(props: IProps) {
        ...
        const showBrandWatermark = false;
    ...
    _renderJitsiWatermark() {
        ...
        if (_showJitsiWatermark) {
            const style = {
                backgroundImage: `url(images/logo-deep-linking-mobile.png)`,
            ...
            if (_logoLink) {
                reactElement = (
                    <a aria-label={t("jitsiHome", { logo: "" })} className={className} href={_logoLink} target="_new">
                        {reactElement}
                    </a>
                );
            }
...
function _mapStateToProps(state: IReduxState, ownProps: any) {
    ...
    const { JITSI_WATERMARK_LINK = "", SHOW_JITSI_WATERMARK = false } = {};
